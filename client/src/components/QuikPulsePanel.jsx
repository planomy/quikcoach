...
function PulseCard({ card, onLaunch }) {
  return (
    <button
      ...
      className="group flex min-h-40 flex-col items-center justify-center rounded-[1.4rem] border-2 border-indigo-100 bg-white px-4 py-5 text-center text-indigo-700 shadow-sm transition hover:-translate-y-0.5 hover:border-indigo-400 hover:bg-indigo-50 hover:shadow-md focus:outline-none focus-visible:ring-4 focus-visible:ring-indigo-200 dark:border-indigo-900 dark:bg-slate-950 dark:text-indigo-300 dark:hover:border-indigo-600 dark:hover:bg-indigo-950/50"
    >
      <span className="grid h-16 w-16 place-items-center rounded-[1.2rem] bg-indigo-50 transition group-hover:bg-white dark:bg-indigo-950 dark:group-hover:bg-indigo-900/70">
  ...
  return (
    <section className="p-4 sm:p-5">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex min-h-40 flex-col items-center justify-center rounded-[1.4rem] border-2 border-indigo-100 bg-white px-4 py-5 text-center text-indigo-700 shadow-sm dark:border-indigo-900 dark:bg-slate-950 dark:text-indigo-300">
          <span className="grid h-16 w-16 place-items-center rounded-[1.2rem] bg-indigo-50 dark:bg-indigo-950">
