            ...
            <details className="mt-4 rounded-xl border border-slate-200 open:bg-slate-50 dark:border-slate-700 dark:open:bg-slate-950/50">
              ...
              <div className="space-y-3 border-t border-slate-200 px-3 py-3 dark:border-slate-700">
                ...
                <div className="flex flex-wrap gap-2">
                  <button type="button" onClick={saveTemplate} className="rounded-lg border border-violet-200 bg-white px-3 py-2 text-xs font-black text-violet-800 dark:border-violet-800 dark:bg-slate-900 dark:text-violet-200">Save for later</button>
                  <button type="button" onClick={addToQueue} className="rounded-lg bg-violet-100 px-3 py-2 text-xs font-black text-violet-900">Add to queue</button>
                </div>
              </div>
            </details>
