...
export default function RichTextEditor({
  ...
  return (
    <>
      ...
      <div className={`${drawMode ? 'hidden' : ''} iboard-student-writing-card relative overflow-visible rounded-2xl border border-[#e8e8ef] bg-white dark:border-slate-600 dark:bg-slate-900`}>
