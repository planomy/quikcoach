...
export default function RichTextDisplay({ html, text = '', className = '' }) {
  ...
  return (
    <div
      className={`break-words leading-relaxed [&_div]:min-h-[1em] [&_div+div]:mt-2 [&_p]:min-h-[1em] [&_p+p]:mt-2 [&_li+li]:mt-1 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_mark]:rounded-sm [&_mark]:bg-yellow-200 [&_mark]:px-0.5 [&_mark]:text-inherit ${className}`}
